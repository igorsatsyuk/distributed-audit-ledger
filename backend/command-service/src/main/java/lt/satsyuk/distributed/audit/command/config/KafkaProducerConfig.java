...
public class KafkaProducerConfig {
    ...
    private static final String JSON_SERIALIZER_CLASS = "org.springframework.kafka.support.serializer.JsonSerializer";
    ...
    public ProducerFactory<String, AuditEvent> auditEventProducerFactory(
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JSON_SERIALIZER_CLASS);
